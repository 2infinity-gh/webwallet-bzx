$(document).ready(function() {
	...
	/* open wallet code */
    var explorer = "https://apixx.ovh/"
    var explorer_api = explorer;
	...
	function walletApiBalance() {
	 ...
	 $.ajax ({
		 type: "GET",
		 url: "https://apixx.ovh/?s=bzx&q=getbalance&a="+$("#walletAddress").html(),
		 dataType: "json",
		 error: function(data) {
	...
	function getTxConf(txid,cb,cberr){
		$.ajax ({
			type: "GET",
			url: "https://apixx.ovh/?s=bzx&q=getrawtx&tx="+txid,
			dataType: "json",
			error: function(data) {
				cberr();
				$("#redeemFromStatus").removeClass('hidden').html('<span class="glyphicon glyphicon-exclamation-sign"></span> Unexpected error, unable to retrieve unspent outputs!');
	...
	function getAddressTx(cb, cberr){
		$.ajax ({
			type: "GET",
			url: "https://apixx.ovh/?s=bzx&q=addr&a="+$("#walletAddress").html(),
			dataType: "json",
			error: function(data) {
				cberr();
				$("#redeemFromStatus").removeClass('hidden').html('<span class="glyphicon glyphicon-exclamation-sign"></span> Unexpected error, unable to retrieve unspent outputs!');
...
/* JSON	*/
	...
	function listUnspentDefault(redeem){
		$.ajax ({
			type: "GET",
			url: "https://apixx.ovh/?s=bzx&q=listunspent&a="+redeem.addr,
			dataType: "json",
			error: function(data) {
				$("#redeemFromStatus").removeClass('hidden').html('<span class="glyphicon glyphicon-exclamation-sign"></span> Unexpected error, unable to retrieve unspent outputs!');
			},
	...
	function rawSubmitDefault(thisbtn){ 
		...
		//var rawtxhex = { tx_hex: $("#rawTransaction").val()}
                $.ajax ({
                        type: "GET",
                        url: "https://apixx.ovh/?s=bzx&q=broadcastraw&tx_hex="+$("#rawTransaction").val(),
...
// broadcast transaction Bitcoinzero
	function rawSubmitbzx(thisbtn){ 
		...
		//var rawtxhex = { tx_hex: $("#rawTransaction").val()}
                $.ajax ({
                        type: "POST",
                        url: "https://apixx.ovh/?s=bzx&q=broadcastraw",
			            data: { tx_hex: $("#rawTransaction").val() , coin: "bzx"},
                        error: function(data) {
				var obj = $.parseJSON(data.responseText);
				var r = ' ';
